...
export default function AppropriationsPage() {
  ...
  return (
    <>
      ...
      <AlertDialog open={!!appropriationToDelete} onOpenChange={(isOpen) => !isOpen && setAppropriationToDelete(null)}>
        {appropriationToDelete && (
          <AlertDialogContent>
              ...
              <AlertDialogFooter>
              <AlertDialogCancel onClick={() => setAppropriationToDelete(null)}>إلغاء</AlertDialogCancel>
              <AlertDialogAction
