...
-   `src/app`: يحتوي على صفحات التطبيق والمسارات.
    -   `dashboard/`: الصفحات الرئيسية للتطبيق (لوحة التحكم، الاستلام، التسليم، التقارير، إدارة الجهات، إدارة التجهيزات، إدارة وسائل النقل، الروزنامة, الاعتمادات، الإعدادات).
